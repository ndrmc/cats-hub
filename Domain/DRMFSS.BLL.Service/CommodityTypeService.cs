...
namespace DRMFSS.BLL.Services
{
    ...
    public class CommodityTypeService : ICommodityTypeService
    {
        ...
        public List<ViewModels.Common.CommodityTypeViewModel> GetAllCommodityTypeForReprot()
        {
            ...
            var commodityTypes = (from c in tempCommodityTypes select new ViewModels.Common.CommodityTypeViewModel() { CommodityTypeId = c.CommodityTypeID, CommodityTypeName = c.Name }).ToList();
